...
class UserRepository(object):
    ...
    # (id, username, "password", role_id, user_status_id, save_session, seller_id, email)
    # (id, username, "password", role_id, user_status_id, save_session, seller_id, email, first_names, last_names, created_at)
