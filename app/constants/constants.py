...
# Shop directory
DIRECTORY_SHOP_TABLE = '"IFILEDIR"'
DIRECTORY_SHOP_PARTNER_ID = 'partner_id'
DIRECTORY_SHOP_CATEGORY_ID = 'category_id'
DIRECTORY_SHOP_IDENTIFIER = 'identifier'
DIRECTORY_SHOP_PATH = '"path"'
DIRECTORY_SHOP_CREATED_USER = 'created_user'
DIRECTORY_SHOP_CREATED_DATE = 'created_date'
DIRECTORY_SHOP_LAST_UPDATE = 'last_update'
